...
class NasBench101SearchSpace(Graph):
    ...
    def __init__(self):
        ...
        node_pair.update_edges(
            update_func=lambda current_edge_data: _set_node_ops(
                current_edge_data, C=channels[0]
            ),
            scope="node",
        ...
        cell.update_edges(
            update_func=lambda current_edge_data: _set_cell_ops(
                current_edge_data, C=channels[0]
            ),
            scope="cell",
            private_edge_data=True,
    ...
    def query(
        ...
        assert epoch in [
            ...
            108,
            None,
        ], "nasbench101 does not have full learning curve information"
